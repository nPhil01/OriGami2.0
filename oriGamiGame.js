var app = angular.module("oriGamiGame", ['leaflet-directive','ui.bootstrap','angularModalService']);
...
app.controller('MController', function($scope, ModalService) {

    $scope.showNewRoute = function() {
    ...
    $scope.showloadRoute = function() {
        ModalService.showModal({
            templateUrl: 'loadroutemodal.html',
            controller: "ModalController"
        }).then(function(modal) {
            modal.element.modal();
            modal.close.then(function(result) {
    ...
    $scope.showChangeRoute = function() {
        ModalService.showModal({
            templateUrl: 'changeRoutemodal.html',
            controller: "ModalController"
        }).then(function(modal) {
            modal.element.modal();
            modal.close.then(function(result) {
...
app.controller('ModalController', ["$scope" , "$http" ,'leafletData',  function($scope, close, leafletData) {
